...
try {
    ...
    if ($maquina) {
        ...
        // Consulta para os requisitos de Operacional associados ao tipo da máquina
        $sqlRequisitos = "
            ...
            WHERE tr.tipomaquina_id = :tipomaquina_id AND r.tipo_req = 'Operacional'
        ";
...
<body class="body-check-operacional">
    ...
    <h1 class="checkoperacional" style="font-size:30px">Checklist Operacional</h1>
    ...
    <form method="post" id="mainForm" require>
        <div class="colab">
            ...
            <h3 class="titulochecks" style="margin-bottom:25px">Requisitos Operacionais</h3>
        </div>
        ...
        <?php foreach ($requisitos as $requisito): ?>
            <label class="checkbox">
                ...
                <svg required class="checkbox-check" >
                    <polyline points="20 6 9 17 4 12" class="tnt"></polyline>
                </svg>
                
               <label class="tnt"><?= htmlspecialchars($requisito['requisito_topico']) ?></label>
            </label><br>
        <?php endforeach; ?>
